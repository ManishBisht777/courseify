...
export default function Home() {
  return (
    <>
      <section className="min-h-screen space-y-6 md:pt-2 lg:py-4">
        <div className="container flex max-w-[64rem] flex-col items-center justify-center gap-4 text-center">
          ...
          <p className="max-w-[42rem] leading-normal text-slate-700 sm:text-lg sm:leading-8 md:text-lg">
            I&apos;m building a web app with Next.js 13 to provide crisp content
      ...
      <section id="features" className="space-y-6 md:pt-2 lg:py-4 ">
        <div className="container flex max-w-[64rem] flex-col items-center justify-center gap-4 text-center">
          <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
            <h2 className="text-3xl font-bold leading-[1.1] text-foreground sm:text-3xl md:text-6xl">
              Features
            </h2>
            <p className="max-w-[42rem] leading-normal text-slate-700 sm:text-lg sm:leading-8 md:text-lg">
              List of things this project has to offer for both contributors and
              not contributors
            </p>
          </div>
          <div className="mx-auto mt-6 grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
            ...
            <div className="relative overflow-hidden rounded-lg border bg-background p-2">
              <div className="flex h-[180px] flex-col items-center justify-between rounded-md p-6">
                ...
                <div className="space-y-2">
                  <h3 className="font-bold">Content Layer</h3>
                  <p className="text-sm text-muted-foreground">
                    Docs, Blogs and Courses using Mdx and content layer
                  </p>
                </div>
              </div>
            </div>
            <div className="relative overflow-hidden rounded-lg border bg-background p-2">
              <div className="flex h-[180px] flex-col items-center justify-between rounded-md p-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Crisp content on various topics with resources
                  </p>
                </div>
              </div>
            </div>
            <div className="relative overflow-hidden rounded-lg border bg-background p-2">
              <div className="flex h-[180px] flex-col items-center justify-between rounded-md p-6">
                ...
                <div className="space-y-2">
                  <h3 className="font-bold">Many more</h3>
                  <p className="text-sm text-muted-foreground">
      ...
      <section id="open-source" className="container py-8 md:py-12 lg:py-24">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-6 text-center">
          ...
          <div className="max-w-[42rem] leading-normal text-slate-700 sm:text-lg sm:leading-8 md:text-lg">
            Courseify is open source and powered by open source software. <br />{" "}
            ...
            <div className="mt-3 flex justify-center gap-4">
              ...
              <Link href="/" className={cn(buttonVariants(), "px-4 hidden")}>
                <svg
